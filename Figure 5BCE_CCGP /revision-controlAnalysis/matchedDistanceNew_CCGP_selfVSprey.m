...
% threshold at 800 px
%load("/Users/assiachericoni/Documents/MATLAB/codes/PacMan/CCGP/data/chunkForCCGP_40s_6BESTbinsPerClass_rightleft_rawTimeDistanceMatched_thr.mat")

% no threshold - only matched distance distributions
load("/Users/assiachericoni/Documents/MATLAB/codes/PacMan/CCGP/data/chunkForCCGP_40s_6BESTbinsPerClass_rightleft_rawTimeDistanceMatched.mat")

%% Filter 
validFeat = var(SelfItems,0,1) > 0 & ...
    var(PreyItems,0,1) > 0 & ...
    var(UnpreyItems,0,1) > 0;

SelfItems   = SelfItems(:, validFeat);
PreyItems   = PreyItems(:, validFeat);
UnpreyItems = UnpreyItems(:, validFeat);

fprintf('Kept %d / %d features after distance-matched item construction\n', ...
    sum(validFeat), numel(validFeat));
...
% Real accuracies
real_prey    = CCGP_real_prey;      % e.g., 0.7319
real_unprey  = CCGP_real_unprey;    % e.g., 0.3244
