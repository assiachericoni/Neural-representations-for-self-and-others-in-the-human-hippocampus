...
decoding = 'antidiagonal'; % 'topbottom' or 'diagonal' or 'rightleft'
...
save(['chunckForCCGP_40s_6BESTbinsPerClass_' decoding '.mat'], 'SelfItems', 'PreyItems', 'UnpreyItems', 'ySelf', 'yPrey', 'yUnprey');
